	...
	if(play == 1 && mouse_move == 0){
		if(lastRecordedPos != null){
			//if(userLine[userLine.length - 1].x != lastRecordedPos.x ){
				...
				console.log("UPDATED WHEN NO ENTRY");
			//}
		}
...
var handler_end = function(){
  ...
  audio.removeEventListener('play', handler_play);
	...
	var php_JSON_Handler = "http://localhost/my-site/brain_focus/user_interface/Get Focused Project/php/JSON_Handler.php";
	request.open("POST", php_JSON_Handler, true);
