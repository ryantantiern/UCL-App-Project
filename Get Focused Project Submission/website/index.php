...
<center>
    <div class="col-md-8 col-md-offset-2">
        <h1 style="font-size:60px;">Get Focused!</h1>
    </div>

<br><br><br><br>
    <div class="form-group">
      <h2 style="font-size: 20px"><label for="gender" class="col-xs-12 control-label">Gender</label></h2><br><br>
      <div class="col-xs-12">
...
<br><br><br><br>
<div class="form-group">
    <h2 style="font-size: 20px"><label for="birthdayDate" class="col xs-2 control-label">BIRTHDAY</label></h2>
    <div class="col-xs-12">
        <div class="form-inline">
            <div class="form-group">
...
<br><br><br>
    <div class="form-group">
      <h2 style="font-size: 20px"><label for="musicality" class="col-xs-12 control-label">I have spent much of my free time engaged in music-related activities:</label></h2><br><br>
      <div class="col-xs-12">
        <div class="form-inline">
            <div class="form-group">
              <select class="form-control" id="music-level" required>
                ...
                <option value="8">8</option>
                <option value="9">9</option>
                <option value="10">10 = Completely Agree</option>
              </select>
            </div>
        </div>
       </div>
				...
				<script>
					...
					function packageInfo(){
						if( document.getElementById("gender").value == -123 || document.getElementById("birth-year").value == -123
							...
							var php_session = "../php/sess_addui.php";
